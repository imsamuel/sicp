...
; n−1 whose square is equal to 1 modulo n. It is possible to prove that if such
; a nontrivial square root of 1 exists, then n is not prime. It is also possible
